...
<style type="text/css">.contact_info{width:100%}.contact_info .phone{background:url('assets/images/vivanta-sprites.png') no-repeat;background-position:-150px -455px;padding-left:105px;min-height:90px;margin-bottom:30px}.contact_info .mail{background:url('assets/images/vivanta-sprites.png') no-repeat;background-position:-150px -308px;padding-left:105px;min-height:90px;margin-bottom:30px}.contact_info .adress{background:url('assets/images/vivanta-sprites.png') no-repeat;background-position:-150px -147px;padding-left:105px;min-height:90px;margin-bottom:30px}.custsuccess{border:1px solid #eaeaea;color:#f90;font-weight:700;margin:100px;padding:86px;position:absolute}</style>
</head>
...
<div class="span6">
<label>Name</label>
<input name="response_name" id="response_name" type="text" class="span12" autocomplete="off" placeholder="Your name"><div class="ui-tooltip">Enter Your Name.</div><label id="usernamelabel" class="alert-error"></label>
</div>
<div class="span6">
<label>Mobile</label>
...
<select name="responsed_city" id="responsed_city" class="span12"><option value="" selected>Select Country / City</option><optgroup label="Countries World Wide"><option value="Afghanistan">Afghanistan</option>
...
<div class="span12">
<label>Message</label>
<div class="input-container"><textarea name="enquiry_details" id="enquiry_details" class="span12"></textarea></div><div class="ui-tooltip"></div><label id="detailslabel" class="alert-error"></label>
</div>
</div>
<div class="row-fluid">
...
<div class="row-fluid">
<div class="span12">
<div id="subber"><input type="submit" id="submitlink" onclick="checkval(this)" name="submitlink" value="Send Message" class="btn btn-default"></div>
</div>
</div>
</fieldset>
</form>
