...
<head>
    ...
    <style type="text/css">
        .contact_info {
            ...
            .contact_info .phone {
                background: url('assets/images/vivanta-sprites.png') no-repeat;
        ...
        <div class="titleBox">
            <div class="container">
                ...
                <ul class="breadcrumb pull-right" itemscope itemtype="http://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                        <a itemprop="item" href="https://www.vivantatechnologies.com/contact-us">
            ...
            <div class="row-fluid topSpace">
                <div class="span5">
                    <div class="contactBox">
                        <div class="span12">
                            <h2 class="twoLines">Bangalore, India</h2>
                       ...
                       <form action="javascript:void(0);" method="post" name="pk_user" autocomplete="off" id="form2">
                           <fieldset>
                               <div class="row-fluid">
                                   <div class="span6">
                                       <label>Name</label>
                                       <input name="response_name" id="response_name" type="text" class="span12" autocomplete="off" placeholder="Your name"><div class="ui-tooltip">Enter Your Name.</div>
                                       <label id="usernamelabel" class="alert-error"></label>
                                   </div>
                                   <div class="span6">
                                       <label>Mobile</label>
                                       <input name="response_mobile" id="response_mobile" type="text" placeholder="Your Mobile" onkeydown="return numberonly(event)" maxlength='15' class="span12" onkeypress="return is_int(event.keyCode?event.keyCode:event.which?event.which:event.charCode)" />
                                       <div class="ui-tooltip"></div>
                                       <label id="mobilelabel" class="alert-error"></label>
                                   </div>
                               </div>
                               <div class="row-fluid">
                                   <div class="span6">
                                       <label>Email</label>
                                       <input name="response_email" id="response_email" type="text" placeholder="Email-id" class="span12" />
                                       <div class="ui-tooltip">Your Mobile Number.</div>
                                       <label id="emailabel" class="alert-error"></label>
                                   </div>
                                   <div class="span6">
                                       <label>Your Country / City</label>
                                       <select name="responsed_city" id="responsed_city" class="span12">
                                           ...
                                           <optgroup label="Countries World Wide">
                                               ...
                                               <optgroup label="Goa">
                                                   <option value="Goa">Goa</option>
                                                   <option value="Pernem Taluka">Pernem Taluka</option>
                                                   ...
                                                   <option value="GOA-Madgaon">GOA-Madgaon</option>
                                               ...
                                               <optgroup label="Himachal Pradesh">
                                                   ...
                                                   <option value="Chintpurni">Chintpurni</option>
                                               ...
                                               <optgroup label="Kerala">
                                                   ...
                                                   <option value="Chathanoor">Chathanoor</option>
                                               ...
                                               <optgroup label="Punjab">
                                                   ...
                                                   <option value="Ropar/Rupnager">Ropar/Rupnager</option>
                                               ...
                                               <optgroup label="TamilNadu">
                                                   ...
                                                   <option value="Raulapalem">Raulapalem</option>
                                               ...
                                               <optgroup label="Uttar Pradesh">
                                                   ...
                                                   <option value="Mahona">Mahona</option>
                                       ...
                                       <div class="ui-tooltip"></div>
                                       <label id="yourcitylabel" class="alert-error"></label>
                                   </div>
                               </div>
                               <div class="row-fluid">
                                   <div class="span12">
                                       ...
                                       <div class="input-container">
                                           <textarea name="enquiry_details" id="enquiry_details" class="span12"></textarea></div>
                                       <div class="ui-tooltip"></div>
                                       <label id="detailslabel" class="alert-error"></label>
                                   </div>
                               </div>
                               <div class="row-fluid">
                                   <div class="span12" id="captcha_details">
                                       <label>reCAPTCHA</label>
                                       <input type="hidden" value="/contact-us" name="source" id="source" />
                                       <div class="g-recaptcha" data-sitekey="6Le1MSYUAAAAAPhLYFZbvQdfH1tV_Y7WDzYyPLxG"></div>
                                       <label id="captchalabel" class="alert-error"></label>
                                   </div>
                               </div>
                               <div class="row-fluid">
                                   <div class="span12">
                                       <div id="subber">
                                           <input type="submit" id="submitlink" onclick="checkval(this)" name="submitlink" value="Send Message" class="btn btn-default"></div>
                                   </div>
                               </div>
                           </fieldset>
                       </form>
