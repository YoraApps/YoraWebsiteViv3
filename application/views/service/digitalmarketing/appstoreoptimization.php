...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/app-store-optimization" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/app-store-optimization" />
</head>
...
<meta itemprop="position" content="4" />
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
        <h2 class="twoLines">Introduction to App Store Optimization or ASO</h2>
        <p>SEO has become a demanding tool in getting traffic volume and high visibility to the website. Moreover, in today's world, mobile users are increasing and are looking out for new applications for mobile phones in the market, it requires an optimization. App Store Optimization or ASO is a new concept in getting visibility and rankings for applications. The concept and method is similar to SEO and it is required to have knowledge and experience in SEO. </p>
...
<li>Understanding users and researching the keywords on search engines</li>
</ul>
<h2 class="twoLines">Why ASO?</h2>
<p>ASO has become one of the most important in optimizing apps as number of users are increasing in downloading new applications in the market of smartphones and tablets.</p>
<ul class="normal dot">	<li>Various Search Engines</li>
<li>App Store Rankings</li>
<li>App Name</li>
<li>App Keywords </li>
<li>App Descriptions</li>
<li>App Icon</li>
<li>Categories and Subcategories</li>
<li>Updates</li>
</ul>
<p>Our method is based on efficiency and reliability to perform App Store Optimization. We are looking forward for your kind gesture in making your App's available for the users across the globe! </p>
      </div>
      <div class="span4">
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/app-store-optimization" name="source" id="source"  />
