...
<meta itemprop="position" content="4" />
  ...
  <div class="container">
  <div class="row-fluid topSpace">  <div class="statsWrap">
            	<div class="stats">
                    <div class="statDummy"></div>
                    <div class="statInfo">
                       <p class="statNumber">Google</p>
                        <p class="statText">PPC Management Services on Google for instant traffic and effective results</p>
                    </div>
                </div>
            </div>
            <div class="statsWrap">
            	<div class="stats">
                    <div class="statDummy"></div>
                    <div class="statInfo">
                    <p class="statNumber">Facebook</p>
                    <p class="statText">Grow your business with Facebook...a treasure of ad campaigns</p>
                    </div>
                </div>
            </div>
            <div class="statsWrap">
            	<div class="stats">
                    <div class="statDummy"></div>
                    <div class="statInfo">
                        <p class="statNumber">Bing</p>
                        <p class="statText">PPC Management Services for better fortune with Bing Ads</p>
                    </div>
                </div>
            </div>
            <div class="statsWrap">
            	<div class="stats">
                    <div class="statDummy"></div>
                    <div class="statInfo">
                        <p class="statNumber">Yahoo!</p>
                        <p class="statText">PPC Management Services by engaging potential visitors on Yahoo!</p>
                    </div>
                </div>
            </div>
</div>
    <div class="row-fluid topSpace">
      <div class="span8">
<h2 class="twoLines">PPC Management Services Bangalore</h2>
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/ppc-management-services" name="source" id="source"  />
