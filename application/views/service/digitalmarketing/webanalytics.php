...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/web-analytics" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/amp/web-analytics" />
</head>
...
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="http://www.yora.xyz/CodeIgniter/index.php/service/web-analytics">
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
        ...
        <p>Web Analytics is all about measurement, collection, analyzing and reporting of Internet Data. It is commonly done for the purpose of optimizing web usage. <a href="http://www.yora.xyz/CodeIgniter/index.php/service/digital-marketing">Online marketing</a>, business research, and E-commerce enterprise companies use Web Analytics to measure the results of traditional print advertising campaigns. It helps companies in advertising campaigns, traffic, number of visitors flow for the website, and number of page views.</p>
