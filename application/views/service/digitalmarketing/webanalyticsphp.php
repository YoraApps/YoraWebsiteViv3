...
<html lang="en">
<head>
<title>Web Analytics Consulting | Web Analytics Services Bangalore</title>
<meta name="description" content="Web Analytics services in Bangalore is a cost effective tool in measuring visitors data and gauging traffic. Please visit at Vivanta Technologies!" />
<meta name="keywords" content="Web Analytics Services Bangalore, Web Analytics Company, Web Analytics Consulting Services Bangalore" />
...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/web-analytics" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/web-analytics" />
</head>
...
<div id="boxedWrapper">
  ...
  <div class="titleBox">
    <div class="container">
      <h1 class="big pull-left">Analysis and reporting of Internet Data - Web Analytics</h1>
...
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="https://www.vivantatechnologies.com/web-analytics">
<span itemprop="name">Web Analytics</span></a>
<meta itemprop="position" content="4" />
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
        <h2 class="twoLines">Web Analytics Optimization</h2>
        <p>Web Analytics is all about measurement, collection, analyzing and reporting of Internet Data. It is commonly done for the purpose of optimizing web usage. <a href="https://www.vivantatechnologies.com/digital-marketing">Online marketing</a>, business research, and E-commerce enterprise companies use Web Analytics to measure the results of traditional print advertising campaigns. It helps companies in advertising campaigns, traffic, number of visitors flow for the website, and number of page views.</p>
        
        <br>
        
       <h2 class="twoLines">Web Analytics Applications </h2>
<ul class="normal dot">	<li>Web Analytics is not just a tool for measuring website traffic but also used as a tool for business and market research which is very important in today's competitive world. </li>
<li>It helps to provide data on the number of visitors, how and where the visitors interact with the website, and the number of page views. </li>
<li>It also helps to gauge traffic and popular trends which are helpful for marketing research.</li>
</ul>

<h2 class="twoLines">Categories of Web Analytics</h2>
<p>Web Analytics are broadly classified into two types; Off-site web analytics and On-site web analytics.
Off-site web analytics: It refers to measurement and analysis of the web, whether you own or maintain a website. This includes the measurement of a website's potential audience (opportunity), visibility or share of voice, and comments or buzz, which is happening on the Internet.</p>
<p>On-site web analytics: It is used to measure a visitor's behavior on your website. This includes drivers and conversations; for instance, different landing pages are associated with online purchases. The performance of a website in a commercial context is measured by On-site web analytics. The data are conventionally compared in contrast to key performance indicators, and marketing campaign's for audience response. Google Analytics is the most widely used on-site web analytics and new web analytics tools are emerging with additional layers of information. </p>

<h2 class="twoLines">Some of the Key features of Web Analytics:</h2>

<ul class="normal dot">	<li>Keyword Research and Source</li>
<li>Page View</li>
<li>Website and Search Engine Traffic</li>
<li>Referral links</li>
<li>Tracking Visitors</li>
<li>Bounce Rate</li>
</ul>
<p>Vivanta Technologies provides services in Web Analytics, which has a track record of improving search engine rankings for the websites. Our priority is to achieve top search results and increase rankings for our esteem clients. We implement Web Analytics to maximize website traffic with effective measurement and performance to optimize your website. </p>
      </div>
      <div class="span4">
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/web-analytics" name="source" id="source"  />
