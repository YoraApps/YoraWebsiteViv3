...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/search-engine-marketing" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/search-engine-marketing" />
</head>
...
<p>Social Networking sites are the best instance of adding SEM for marketing campaigns.</p>
<p>Facebook is the best instance of SEM advertising campaigns where various ads are displayed on the Facebook website when you logged in to the account. This will help in promoting your products and getting visitors on your website. Getting "Facebook likes" for your business is yet another example of the SEM services process.</p>
<ul class="normal dot">	<li>This will increase in number of visitors.</li>
...
<li>Google Campaigns.</li>
<li>Yahoo Campaigns.</li>
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/search-engine-marketing" name="source" id="source"  />
