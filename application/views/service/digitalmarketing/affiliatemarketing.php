...
<html lang="en">
<head>
<title>Affiliate Marketing Services Company | Yora Technologies</title>
<meta name="description" content="Yora Technologies, a professionally driven team with dynamic skills in providing Affiliate Marketing services in Bangalore for online Ad campaigns." />
<meta name="keywords" content="Affiliate Marketing Services, Affiliate Marketing Company, Online Affiliate Marketing Services, Internet Affiliate Marketing" />
...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/affiliate-marketing" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/amp/affiliate-marketing" />
</head>
...
<div id="boxedWrapper">
  ...
  <div class="titleBox">
    <div class="container">
      <h1 class="big pull-left">Marketing solution on the Internet and Mobile Media - Affiliate Marketing </h1>
...
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="http://www.yora.xyz/CodeIgniter/index.php/service/affiliate-marketing">
<span itemprop="name">Affiliate Marketing</span></a>
<meta itemprop="position" content="4" />
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
        <h2 class="twoLines">Affiliate Marketing</h2>
        <p>Affiliate Marketing is an internet marketing services in which an organization pays for each visitor or customer brought by affiliate markets. Affiliate Marketing is promoting other people's (Company's) product or service based on commission (if a sale is made). </p>
        <p>Affiliate Marketing has emerged as a most powerful tool for marketing and is a profitable way to target and attract online visitors by means of various affiliate marketing services for the advertisement of products and/or services. </p>
<p>Affiliate Marketing is one of the cost-effective and easiest way to earn money. It does not require to own products, it just require to link up buyer and seller.</p>
        <br>
<h2 class="twoLines">Our Affiliate Marketing services help with the visibility of your business: </h2>
<ul class="normal dot"> <li>Target traffic through <a href="http://www.yora.xyz/CodeIgniter/index.php/service/search-engine-optimization">SEO</a> to generate sales and affiliate programs. </li>
<li>Strategic planning for various promotional campaigns.</li>
<li>Recognizing affiliate and reliable networks.</li>
<li>Researching the newly launched and branded products and services.</li>
<li>Implementing new techniques in affiliate marketing for your business.</li>
<li>Affiliate Payment methods: <a href="http://www.yora.xyz/CodeIgniter/index.php/service/ppc-management-services">Pay per Click (PPC)</a>, Pay per Sale (PPS), Pay per Lead (PPL).</li>
<li>Focus to magnify sales and Return of Investment (ROI) to augment your business.</li> 
</ul>
      </div>
      <div class="span4">
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/affiliate-marketing" name="source" id="source"  />
