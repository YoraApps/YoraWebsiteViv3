...
<html lang="en">
<head>
<title>Digital Marketing Courses in Bangalore</title>
<meta name="description" content="Digital Marketing courses at Vivanta Technologies is a perfect runaway in elevating new opportunities in the generation of internet marketing world." />
<meta name="keywords" content="Digital Marketing Training Courses, Digital Marketing Training, Online Marketing Courses, Internet Marketing Training Courses Bangalore, Corporate Digital Marketing Training Company" />
...
a{text-align:left;width:100%;height:100%;display:block;color:#333;position:relative}.ca-icon{font-size:40px;color:#f6f6f6;line-height:60px;position:absolute;width:100%;height:60px;left:0px;top:30px;text-align:center;-webkit-transition:all 400ms linear;-moz-transition:all 400ms linear;-o-transition:all 400ms linear;-ms-transition:all 400ms linear;transition:all 400ms linear}.ca-main{font-size:24px;font-weight:normal;text-transform:uppercase;line-height:1;position:absolute;top:110px;height:80px;width:170px;left:50%;margin-left:-93px;opacity:0.8;text-align:center;color:#555}.ca-sub{display:none}.ca-menu li:hover{border-color:#0dc3ff;z-index:999;-webkit-transform:scale(1.1);-moz-transform:scale(1.1);-o-transform:scale(1.1);-ms-transform:scale(1.1);transform:scale(1.1)}.ca-menu li:hover .ca-main{color:#000;-webkit-animation:moveFromBottom 500ms ease;-moz-animation:moveFromBottom 500ms ease;-ms-animation:moveFromBottom 500ms ease}.clear{clear:both;display:block;overflow:hidden;visibility:hidden;width:0;height:0}.clearfix:before,.clearfix:after{content:'\0020';display:block;overflow:hidden;visibility:hidden;width:0;height:0}.clearfix:after{clear:both}.clearfix{zoom:1}
</style>
</head>
...
<div id="boxedWrapper">
  ...
  <div class="titleBox">
    <div class="container">
      <h1 class="big pull-left">Digital Marketing Courses in Bangalore, Strategy Management by Corporate Trainers.</h1>
...
<span itemprop="name">Corporate Training</span></a>
<meta itemprop="position" content="3" />
</li>
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="https://www.vivantatechnologies.com/digital-marketing-courses">
<span itemprop="name">Digital Marketing Courses</span></a>
<meta itemprop="position" content="4" />
  ...
  <div class="row-fluid topSpace">
     <div class="mbs clearfix">
					<ul class="ca-menu animtt" data-gen="fadeInLeft" data-gen-offset="bottom-in-view">
						<li>
							<a href="javascript:void(0);">
								<div class="ca-content">
									<h2 class="ca-main">Exceptional Training</h2>
								</div>
							</a>
						</li><!-- end service -->
						<li>
							<a href="javascript:void(0);">
								<div class="ca-content">
									<h2 class="ca-main">Creative Demo</h2>
								</div>
							</a>
						</li><!-- end service -->
						<li>
							<a href="javascript:void(0);">
								<div class="ca-content">
									<h2 class="ca-main">Infographical Procedure</h2>
								</div>
							</a>
						</li><!-- end service -->
						<li>
							<a href="javascript:void(0);">
								<div class="ca-content">
									<h2 class="ca-main">Professional Team</h2>
								</div>
							</a>
						</li><!-- end service -->
						<li>
							<a href="javascript:void(0);">
								<div class="ca-content">
									<h2 class="ca-main">Intellectual Support</h2>
								</div>
							</a>
						</li><!-- end service -->
					</ul><!-- end services ul -->
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
        <h2 class="twoLines">An insight into Digital marketing courses in Bangalore.</h2>
        <p>You will hardly find any business enterprise today that does not include digital marketing in its overall marketing strategy. Companies are allocating sizeable budgets for digital marketing of their products and services along with the traditional techniques. This holds good for companies that are marketing products online and also for companies that do not have online marketing arrangements. Therefore, it is imperative that whoever is practicing digital marketing in whatever capacity should have knowledge about the subject and be trained to manage the operations efficiently. Whether you are heading the business operations, a corporate employee or a student, you just cannot do without the knowledge of digital marketing.</p>
        <br>
<h2 class="twoLines">What is digital marketing?</h2>
<p>Digital marketing entails the selling of products or services utilizing the techniques of search engine optimization to earn good rankings of your website in the search engine results. When your website is adequately visible on the web in response to search queries, more traffic will be driven to your website thereby increasing the possibilities of generating more business. Using the various techniques of search engine optimization and advertising on the web you will be able to engage the visitors to your website and drive them to buy your products or services.</p>
<br>
<h2 class="twoLines">Digital marketing courses</h2>
<p>The professionals of internet marketing are deemed to be the best people to give training in internet marketing because the subject involves functional knowledge and skills. Vivanta Technologies is offering digital marketing courses in Bangalore and award certificates on successful completion of the course. The courses are mainly aimed at students as well as working professionals and offers a lot of flexibility in holding classes on weekdays and weekends including evening classes.</p>
<br>
<h3 class="twoLines">Courses offered</h3>
<ul class="normal dot"><li><a href="https://www.vivantatechnologies.com/digital-marketing">Digital Marketing</a> Management.</li>
<li><a href="https://www.vivantatechnologies.com/search-engine-optimization">Search engine optimization</a> (SEO).</li>
<li><a href="https://www.vivantatechnologies.com/search-engine-marketing">Search engine marketing</a> (SEM) and <a href="https://www.vivantatechnologies.com/ppc-advertising-company">PPC Management Services</a> (Pay per click).</li>
<li><a href="https://www.vivantatechnologies.com/web-analytics">Web Analytics mangement</a>.</li>
<li><a href="https://www.vivantatechnologies.com/social-media-optimization">Social Media Optimization</a> (SMO).</li>
<li><a href="https://www.vivantatechnologies.com/online-reputation-management">Online Reputation Management</a> (ORM).</li>
...
<p>All the courses are designed to impart knowledge as well as develop the skills necessary to utilize the knowledge in a meaningful way. Case studies and role play sessions together with hands on training and extensive discussions make the curriculum more practical oriented.</p>
<br>
<h3 class="twoLines">Digital Marketing courses</h3>
<p>The course is about the development of a successful digital marketing plan and imparts knowledge about inbound marketing and web / digital marketing. It teaches the fundamentals of marketing plan, how to develop a plan using the right resources, incorporate skills into it and then communicating it effectively for successful implementation. Techniques of integrating digital marketing with conventional marketing are also included in the course.</p>
<br>
<h3 class="twoLines">SEO course</h3>
<p>The basic guidelines of search engine optimization forms the foundation of the course that imparts knowledge about the working of search engines and the best practices to be followed according to the established guidelines of Google and other search engines. It highlights the method of building websites meant for the target audience and talks about various SEO strategies and tools that are used to develop a successful SEO campaign.</p>
<br>
<h3 class="twoLines">SEM and Pay per click advertising course</h3>
<p>The course is designed to give a clear understanding about the role of SEM and teaches the techniques of how to maximize the opportunities of advertising on Google Adwords or Bing by using pay per click techniques. It teaches how to increase brand or website visibility that would drive more targeted traffic to the website that ensures better return on investment.</p>
<br>
<h3 class="twoLines">Affiliate marketing course</h3>
<p>Affiliates are like authorized agents of business who undertake promotional campaigns on behalf of the principals to sell their products. There may be several affiliates of a business enterprise that rewards the affiliates whenever the leads that they generate are converted into sales. <a href="https://www.vivantatechnologies.com/affiliate-marketing">Affiliate marketing</a> is part of e tailers and the e commerce industry. The course gives in depth knowledge about affiliate marketing and teaches the methods of making money online by promoting products or services.</p>
<br>
<h3 class="twoLines">Web Analytics course</h3>
<p>The course teaches how to make best use of web analytics to improve the performance of websites that could strengthen internet marketing. Web analytics comprises various performance data of websites which gives a clear picture to analyze how websites are performing and devise strategies of improving performance. The course explains the importance of each type of data, ways to analyze data and how to use the data that could boost performance.</p>
<p>The faculty comprises a professional team who use highly interactive training modules to impart the best in class training and learning that adds real value to the careers of the learners.</p>
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/digital-marketing-courses" name="source" id="source"  />
