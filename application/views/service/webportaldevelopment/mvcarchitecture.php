...
<html lang="en">
<head>
<title>MVC Web Applications Development | Yora Technologies</title>
<meta name="description" content="yora Technologies is a Web Development Company in India offering MVC Architecture in Web Applications using PHP frameworks like Cake PHP and CodeIgniter." />
<meta name="keywords" content="MVC Architecture, MVC Web Development Company, CakePHP Development Company India, CodeIgniter Development Company in Bangalore" />
...
<div id="boxedWrapper">
  ...
  <div class="titleBox">
    <div class="container">
      <h1 class="big pull-left">High-performance MVC-based PHP framework for developing</h1>
...
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="http://www.yora.xyz/CodeIgniter/index.php/service/mobilewebsitedevelopment">
<span itemprop="name">MVC Architecture</span></a>
<meta itemprop="position" content="4" />
     ...
     <ul class="ca-menu row-fluid">
                    <li>
                        <a href="#">
                            ...
                            <div class="ca-content">
                                <h2 class="ca-main">Pull the data</h2>
                                <h3 class="ca-sub">Model</h3>
                            </div>
                        </a>                   
                    </li>
                    <li>
                        <a href="#">
                            ...
                            <div class="ca-content">
                                <h2 class="ca-main">Creative display</h2>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <div class="ca-content">
                                <h2 class="ca-main">The Evangelist</h2>
                                <h3 class="ca-sub">Controller</h3>
                            </div>
                        </a>                    
                    </li>
    </ul>
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
        <h2 class="twoLines">MVC Architecture Web Development</h2>
        <p>Model View Controller Architecture has become a most powerful software design pattern to develop World Wide Web Applications. 
</p>
<h3 class="light">It is described into three components:</h3>
<h4>Model </h4>
 <p> It is a pattern which is responsible for maintaining the data. The Model is where data of the application domain,  responds to the request from the view and respond to the instructions from the controller to update.</p>
<h4>View </h4> 
<p> The View manages the display of all the data to the user. It often collects the data from the users. The view is made of templates like HTML, CSS, and PHP which is flexible in AJAX technology. </p>

<h4>Controller </h4>
<p> The Controller interprets the Model and the View, using the Software code. The controller updates and manipulate data based on the inputs.
</p>
<br>
<h3 class="light">Features of the MVC Architecture in Web applications:</h3>
<p>Use in Web platforms that uses HTML.</p>
<p>Designing and developing Web applications using PHP frameworks like Laravel, Cake PHP and Codeigniter.</p>
<p>MVC is a design pattern which separates user-interface from application logic. We've a professional team in creating a user friendly web applications with the purpose of static and dynamic website.
</p>
      </div>
      <div class="span4">
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/mvc-architecture" name="source" id="source"  />
