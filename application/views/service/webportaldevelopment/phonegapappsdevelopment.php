...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/phonegap-apps-development" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/phonegap-apps-development" />
</head>
...
<ul class="normal dot">	<li>Our development team possesses hands-on experience in working on diverse mobile applications.</li>
<li>We analyze the business requirements for mobile apps to create professional websites.</li>
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/phonegap-apps-development" name="source" id="source"  />
