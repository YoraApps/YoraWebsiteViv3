...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/web-application-development" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/web-application-development" />
</head>
...
<meta itemprop="position" content="4" />
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
        <h2 class="twoLines">Web Application Development</h2>
...
<li>Advanced Web Based Applications.</li>
<li>Rich Internet Applications.</li>
<li>Technology Consulting Services.</li></ul>      
<p>We have a team of experts who are ensure in providing the best Web Application Development Services for scalable and flexible to use applications for different web-portals.</p><p>Our Web App Development Company basically develops a business strategy, which meets your business and marketing goals through excellent services with advanced technologies and web applications tools.</p>
<h2 class="twoLines">Web Application Tools:</h2>
<ul class="normal dot"><li>PHP, Java, JavaScript.</li>
<li>MEAN Stack.</li>
<li>Express, AngularJS, and Node.js.</li>
<li>jQuery, JSON, Bootstrap, Google material design.</li>
<li>MySQL, MongoDB.</li>
<li>HTML 5.</li>
<li>CSS 3.</li>
<li>AJAX.</li>
<li>Laravel, CodeIGniter, Magento/ Open Cart for Ecommerce</li>
<li>CMS (Drupal, Joomla, &amp; Wordpress) and many more!</li></ul>
<p>We carry out effective Web Application Development Services solutions, based on cutting-edge technology, both in back-end and front-end use in creating customized Web Portals for your business needs. Our Web App Development Company in Bangalore has a professional team of developers and programmers in using different platforms.</p>
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/web-application-development" name="source" id="source"  />
