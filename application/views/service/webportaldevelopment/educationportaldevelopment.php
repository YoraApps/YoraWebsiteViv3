...
<html lang="en">
<head>
<title>Providing excellent features for Education Portal Development</title>
<meta name="description" content="Vivanta Technologies provides variant education portal development services for online learning and e-learning purpose with user-friendly features." />
<meta name="keywords" content="Educational Portal Development, E-learning Portal Development Services, E-learning Web Portal Development, Educational Website Development Services" />
...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/education-portal-development" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/education-portal-development" />
</head>
...
<div id="boxedWrapper">
  ...
  <div class="titleBox">
    <div class="container">
      <h1 class="big pull-left">A perfect stop to acquire education Anytime, Anywhere!.</h1>
...
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="https://www.vivantatechnologies.com/education-portal-development">
<span itemprop="name">Education Portal Development</span></a>
<meta itemprop="position" content="4" />
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
        <h2 class="twoLines">Education Portal Development</h2>
        <p>In an era of the Internet and Information Technology, there has been an intend demand for numerous website portals for various businesses and organizations activities. Vivanta Technologies provides services in creating numerous websites. We provide the best education portal development features academic institutions and universities.</p>
<p>Education Portal has emerged as an online education program with sole purpose is to conduct classes for the students through E-learning mode which is simplified for online learning and teaching purpose. Here, students and teachers interact through online video and audio sessions, online posts and forums, online course materials, projects, practical sessions and numerous other resources. It is a tool in which online training classes/sessions are conducted.</p>
<p>At Vivanta Technologies, advanced applications and specialized features with the main objective in developing the best education portal development which enables interactive system for e-Learning tools. We customized our approach as per the clientele needs in creating in providing various services.</p>
<br>
<h3 class="twoLines">Features of Education Portal Development:</h3>
<ul class="normal dot">	<li>Reports and catalogs.</li>
<li>Calendar of events.</li>
<li>Creating online communities and forums (students, administrators and alumni).</li>
<li>Facility to access resources for students, faculty, admin parents.</li>
<li>Library of course materials and assessments.</li>
<li>Test and Exam assessments.</li>
<li>Job opening facilities.</li>
<li>Payment gateway services.</li>
</ul>
<br>
<p>Vivanta Technologies provides excellent services in creating education portal development which allows robust and fascinating features, convenient access and customized applications. Our team of dynamic and professional experts implement advanced web technologies and open source elements for entire web portal solutions.</p>
      </div>
      <div class="span4">
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/education-portal-development" name="source" id="source"  />
