...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/job-portal-development" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/job-portal-development" />
</head>
...
<h3 class="twoLines">Job Seekers:</h3>
        <ul class="normal dot">	<li>Registration</li>
<li>Resume upload</li>
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/job-portal-development" name="source" id="source"  />
