...
<meta itemprop="position" content="4" />
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
        <h2 class="twoLines">B2B &amp; B2C e-Commerce Portal</h2>
...
<li>Managing categories of products, items, and manufacturers</li>
<li>Advance option for upcoming products and items</li>
<li>Admin Tool Panel</li>
<li>User Account Creation</li>
<li>Registering Users</li>
<li>Payment gateway integration and Billing system option.</li>
<li>SMS gateway integration.</li>
<li>Secure transactions with SSL certificate.</li>
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/b2b-and-b2c-e-commerce-portal" name="source" id="source"  />
