...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/travel-portal-development" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/travel-portal-development" />
</head>
...
<h3 class="twoLines">Our Travel Portal Development features:</h3>
        <ul class="normal dot">	<li>Design and Development</li>
...
<br>
<h3 class="twoLines">Our significant features:</h3>
        <ul class="normal dot">	<li>Air Ticket Booking</li>
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/travel-portal-development" name="source" id="source"  />
