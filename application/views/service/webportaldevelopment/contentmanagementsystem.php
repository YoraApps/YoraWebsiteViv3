...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/content-management-system" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/content-management-system" />
<style type="text/css">
...
<meta itemprop="position" content="4" />
  ...
  <div class="row-fluid topSpace">  <div class="statsWrap">
            	<div class="stats">
                    ...
                    <div class="statInfo">
                       <p class="statNumber">Wordpress</p>
                                            </div>
                </div>
            </div>
            <div class="statsWrap">
...
<li>Enterprise Business Sectors.</li>
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/content-management-system" name="source" id="source"  />
