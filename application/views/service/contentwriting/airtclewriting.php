...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/article-writing" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/article-writing" />
</head>
...
<meta itemprop="position" content="4" />
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
        <h2 class="twoLines">Article Writing</h2>
        <p>Vivanta Technologies in Bangalore provides a high quality contents to market your business via online portal. Articles are the best marketing spectrum of the business needs, to promote company's brands, products and services. It provides specific information in providing content for your website. Article writing has also been a tremendous success in the <a href="https://www.vivantatechnologies.com/news-portal-development">news portal</a> in providing accurate information for the readers.</p>
        <p>Nowadays, SEO-friendly article writing has become a crucial part of communication. It increases rankings in search engine pages like Google, Bing, and Yahoo. Our article writing features are as follows</p>
<br>
<h3 class="twoLines">Our features:</h3>
        <ul class="normal dot">	<li>We provide an ideal and impeccably contents for all your business needs. </li>
<li>We also deliver rich quality articles using keywords.</li>
<li>An excellent keyword research.</li>
<li>We provide <a href="https://www.vivantatechnologies.com/search-engine-optimization">SEO</a> related content articles for improving rankings in search engine pages.</li>
<li>Increase in marketing strategies in promoting your business portal.</li>
</ul>
<p>Articles writing helps in  generating a new trend for promotional in building brand services.</p>
<h3 class="twoLines">Benefits of Article writing:</h3>
        <ul class="normal dot">	<li>Brand identity of the business</li>
<li>Link popularity</li>
<li>Increase traffic in search engine</li>
<li>Targeting audience</li>
</ul>

<p>Vivanta Technologies have a proven record of delivering spam free articles using the effective plagiarism checker tool. Our professional writers ensure that the content is provided with every bit of information related to your business or service domain.</p>
<p>Our professional writers ensure in providing informational article writing which is related to various domains and organizations. We're passionate about providing competent and rich article writing content for the website.</p>
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/article-writing" name="source" id="source"  />
