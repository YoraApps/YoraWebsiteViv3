...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/web-services" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/web-services" />
</head>
...
<p>We use Web APIs which allows to use multiple web resources to access more features into new applications which is known as Mashups and XML web services. These services allows to use the messages that follow the <strong>SOAP</strong> standard which are widely used in many traditional enterprises.</p>
<p>According to the Real time analytics, it is about exploring data that will make your business better and improves the product. Mashups are another important website application that integrates data source to create a new service which is displayed in a single interface.</p>
<br>
<h3 class="twoLines">Benefits:</h3>
<p>Finding a geographical location is one of the most popular features with the application of <strong>Google Maps API</strong> which enables applications to perform Geocoding. There is also another web service which is a <strong>RESTful</strong> web service which has an option of making geocoding requests from the server side applications with both XML as well as <strong>JSON</strong>.</p>
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/web-services" name="source" id="source"  />
