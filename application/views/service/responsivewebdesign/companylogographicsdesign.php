...
<html lang="en">
<head>
<title>Logo design company in bangalore | Graphic Design Services Bangalore</title>
<meta name="description" content="Vivanta Technologies, leading Website Logo Design Company in Bangalore offers Company Logo Design, Graphics Design, Corporate Logo Design Services & more." />
<meta name="keywords" content="Corporate Logo Design, Graphics Design Company, Graphics Design Services, Website Logo Design Services Bangalore" />
...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/index.php/company-logo-graphics-design" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/index.php/company-logo-graphics-design" />
</head>
...
<div id="boxedWrapper">
  ...
  <div class="titleBox">
    <div class="container">
      <h1 class="big pull-left">Exclusive Customised &amp; Professional Logo Design</h1>
...
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="https://www.vivantatechnologies.com/amp/responsive-web-design">
<span itemprop="name">Responsive Web Design</span></a>
<meta itemprop="position" content="3" />
</li>
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="https://www.vivantatechnologies.com/amp/company-logo-graphics-design">
<span itemprop="name">Company Logo/Graphics Design</span></a>
<meta itemprop="position" content="4" />
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
<h2 class="twoLines">Company Logo/Graphics Design</h2>
<p>Logo and Graphics Design is a part of the <a href="https://www.vivantatechnologies.com/responsive-web-design">Responsive Web Designing</a> project which illustrates a brand identity of a company or a business. It is a process of creativity that involves conceptualizing logos, website, and graphic designs. </p>
<p>Your Logo will be the first impression for the visitors to attract is your website whereas graphic designing is a concept used in the creation of media and animation.</p>
<p>Vivanta Technologies provides provides a customize entertaining logo and graphic design suitable for your business needs, providing explicit patterns, representing your brand and product globally. </p>
<h2 class="twoLines">Our prominent logo features:</h2>
<ul class="normal dot">	<li>More describable for corporate identity/branding</li>
<li>Motion images</li>
<li>Animation</li>
<li>Representable for your company/brand/business</li>
<li>Updated application and tools for effective design</li>
<li>Effective logo design patterns</li>
<li>Banner advertisements</li>
<li>Cost-effective</li>
<li>User-friendly interface</li>
</ul>
<h2 class="twoLines">Our process</h2>
<p>Our expertise team of designers creates professional and trendy logos, matching your expectations.</p> 
      </div>
      <div class="span4">
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/company-logo-graphics-design" name="source" id="source"  />
