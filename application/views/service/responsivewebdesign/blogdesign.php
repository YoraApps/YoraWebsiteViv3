...
<html lang="en">
<head>
<title>Blog Design Services Company Bangalore - Yora Technologies</title>
<meta name="description" content="Best Blog Design Services at affordable prices. Visit Vivanta Technologies to know more about Blog Design, Blog Design Templates and Website Blog Design." />
<meta name="keywords" content="Blog Design Services, Best Blog Design Company, Website Blog Design Services Bangalore, Blog Design Template Services" />
...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/blog-design" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/amp/blog-design" />
</head>
...
<div id="boxedWrapper">
  ...
  <div class="titleBox">
    <div class="container">
      <h1 class="big pull-left">Content is king, Express yourselves by new and authentic Blog Designs</h1>
...
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="http://www.yora.xyz/CodeIgniter/index.php/service/responsive-web-design">
<span itemprop="name">Responsive Web Design</span></a>
<meta itemprop="position" content="3" />
</li>
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="http://www.yora.xyz/CodeIgniter/index.php/service/blog-design">
<span itemprop="name">Blog Design</span></a>
<meta itemprop="position" content="4" />
  ...
  <div class="container">
    <div class="row-fluid topSpace">
      <div class="span8">
<h2 class="twoLines">Blog Design </h2>
<p>A blog is one of the most communicative tools for discussions, opinions, sharing vital information, on various issues and topics on websites and social networking sites. It has become popular among people in forming a community to discuss using the Internet as a tool. Google, Microsoft and Amazon best examples of blog community.</p>
<p>Vivanta Technologies a leading <a href="https://www.vivantatechnologies.com/">Web development company</a>, provides services in blog design providing with advanced features and applications. </p>
<p>Our professional web designers create mind blowing and beautiful themes and designs with user-friendly interface. We create designs such as background image design, font style, blog layout design, multi-color option, blog redesigning, and customization.
</p>
<h2 class="twoLines">Prominent features and applications:</h2>
<p>We also create blog designs which are feasible for ad integration and social media integration (to attract visitors) with <a href="https://www.vivantatechnologies.com/search-engine-optimization">SEO</a> friendly content.</p>
<ul class="normal dot">	<li>It helps in customizing your design.</li>
<li>Easy publishing of posts and information.</li>
<li>It helps in getting revenue via blog ad integration.</li>
<li>Uploading your images and videos on your post.</li>
<li>Good Return On Investment (ROI).</li>
<li>Group blogging features and many more features!</li>
</ul>
<h3 class="twoLines">Tools:</h3>
<p>We ensure that most advanced and user-friendly softwares are used in making blog sites. WordPress and Blogspot are the most widely used software which are used by our designers in customization of blogs. </p> 
<p>Blogs have become the most demanding communicative and discussion forum in today's world. Hence, new features are being created for various applications for the people to access easily.</p> 
      </div>
      <div class="span4">
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/blog-design" name="source" id="source"  />
