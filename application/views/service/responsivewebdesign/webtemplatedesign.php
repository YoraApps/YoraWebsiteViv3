...
<html lang="en">
<head>
<title>Web Template Design | Website Templates Design Bangalore</title>
<meta name="description" content="Yora Technologies offers Web Templates, Website Template Designs, Wordpress Template Design, Joomla Template Design, HTML 5 Website Template Designs." />
<meta name="keywords" content="Website Template Designs, Web Templates Design, Web Template Design Company, Wordpress Template Design Company, Joomla Template Design Company" />
...
<link rel="canonical" href="http://www.yora.xyz/CodeIgniter/web-template-design" />
<link rel="amphtml" href="http://www.yora.xyz/CodeIgniter/amp/web-template-design" />
<style type="text/css">
...
.cbdashed_header{margin-bottom:40px;margin-top:0}.circle_block_wrapper.dashed
.small_circle{height:106px;width:106px;border-radius:120px;background-color:#28c0ff;text-align:center;margin:46px
0 0 62px;position:relative}.circle_block_wrapper.dashed .small_circle
.dashed_bg{position:absolute;top:-30px;left:-21px;width:116px;display:none}.circle_block_wrapper.dashed .small_circle
img{margin:25px
16px}.circle_block_wrapper.dashed
.small_circle.ss1{margin:48px
0 0 61px}.circle_block_wrapper.dashed
.small_circle.ss2{margin:47px
0 0 62px}.circle_block.dashed{width:228px;height:228px;border-radius:228px;background-color:#00a0db;color:#fff;font-family:'Open Sans',sans-serif;font-size:24px;line-height:26px;display:table-cell;vertical-align:middle;text-align:center;font-weight:400}.circle_block_wrapper.dashed.last{margin-right:0}.about_linked_circles{position:relative;min-height:950px;margin-left:33px;margin-bottom:48px}.about_linked_circles
.bg_img{position:absolute;top:47px;left:0px}.about_linked_circles
.central_circle{width:302px;height:302px;border-radius:305px;background:#00a0db;color:#fff;font-family:'Open Sans',sans-serif;font-size:40px;line-height:40px;display:table-cell;vertical-align:middle;text-align:center}.circle_block_wrapper.central{position:absolute;top:622px;left:295px}.circle_block_wrapper.central
.dashed_bg{position:absolute;top:-5px;left:-5px;width:312px;display:none}.about_separator{border-top:2px solid #282828;height:22px;text-align:center;margin-bottom:24px;display:none;margin-top:48px}@media screen and (max-width:440px){.about_linked_circles{display:none}}@media screen and (max-width:980px){.about_linked_circles{display:none}}@media screen and (max-width:768px){.about_linked_circles{display:none}}
</style>
</head>
...
<div id="boxedWrapper">
  ...
  <div class="titleBox">
    <div class="container">
      <h1 class="big pull-left">Elegant and Structured Template Designing</h1>
      <ul class="breadcrumb pull-right" itemscope itemtype="http://schema.org/BreadcrumbList">
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="hhttp://www.yora.xyz/CodeIgniter">
...
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="http://www.yora.xyz/CodeIgniter/index.php/services/responsive-web-design">
<span itemprop="name">Responsive Web Design</span></a>
<meta itemprop="position" content="3" />
</li>
<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
<a itemprop="item" href="http://www.yora.xyz/CodeIgniter/index.php/services/web-template-design">
<span itemprop="name">Web Template Design</span></a>
<meta itemprop="position" content="4" />
  ...
  <div class="row-fluid topSpace digital-images">
      <div class="span12">
      <div class="about_linked_circles">
				<img class="bg_img" src="assets/images/lines.png" alt="Template Designing" width="894" height="885"/>
				<div class="clear"></div>
				<div class="circle_block_wrapper dashed">
					<h3 class="cbdashed_header">WEB DESIGN</h3>
					<div class="circle_block dashed">
						HTML 5/CSS 3,<br />
						MODERN DESIGN,<br />
						WORDPRESS,<br />
						DRUPAL,<br>
					...
					<div class="small_circle">
						<img src="assets/images/red1.png" alt="WEB DESIGN" height="56" width="74"/> <!-- icon -->
						<img src="assets/images/circle2.png" alt="WEB DESIGN" class="dashed_bg" height="118" width="118"/>
						</div>
					</div>
				<div class="circle_block_wrapper dashed">
					<h3 class="cbdashed_header">DESIGN THEORY</h3>
					<div class="circle_block dashed">
						HTML 5,<br />
                        CSS 3 ANIMATIONS,<br />
						JQUERY<br />
						</div>
					<div class="small_circle ss1">
						<img src="assets/images/red2.png" alt="DESIGN THEORY" height="56" width="74"/> <!-- icon -->
						<img src="assets/images/circle2.png" alt="DESIGN THEORY" height="118" width="118" class="dashed_bg" />
						</div>
					</div>
				<div class="circle_block_wrapper dashed last">
					<h3 class="cbdashed_header">WORKFLOW</h3>
					<div class="circle_block dashed">
						SEQUENCE,<br />
						CONNECTED STEPS,<br />
						PLANNING
						</div>
					<div class="small_circle ss2">
						<img src="assets/images/red3.png" alt="WORKFLOW" height="56" width="74"/> <!-- icon -->
						</div>
					</div>
				<div class="clear"></div>
				<div class="about_separator"></div>
				<div class="circle_block_wrapper central">
    ...
    <div class="row-fluid topSpace">
      <div class="span8">
        <h2 class="twoLines">Web Template Design</h2>
        <p>Yora Technologies provides a wide range of website templates suitable use of individual purpose, business or organization. These templates are built and customize in updating your business or personal info, product description, images and video uploads,  music files, daily events and more.
</p>

<ul class="normal dot">	<li>It gives an option to bring all new website features and applications to explore your business with a new and unique Website Template design. </li>
<li>We design a trendy rich looking portals suitable for your business needs.</li>
<li>We design and customize a wide range of Templates in prioritizing customer's valuable specifications by our qualified professionals and expertise in creating a high quality template. </li>
<li>You can update your business or product info, daily activities.</li> 
</ul>
<br>
        <h3 class="twoLines">Yora Technologies provides the following types of Website Templates:</h3>
        <ul class="normal dot">	<li>HTML 5 &amp; CSS 3</li>
<li>Wordpress</li>
<li>Joomla</li>
<li>Drupal</li>
<li>E-Commerce and many more!</li>
</ul>

        <p>Our ultimate goal is for deploying applications in creating a web template design which is presentable to your esteem clients and customers. There is a Return On Investment (ROI) to attract visitors and transpiring into potential clients. We've a dedicated and energetic team of developers, designers, and programmers in delivering effective templates.</p>
      </div>
      <div class="span4">
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/web-template-design" name="source" id="source"  />
...
</html><p><a href=http://www.yora.xyz/CodeIgniter/index.php/services">Web development company in Bangalore</a></p>
<a href="http://www.yora.xyz/CodeIgniter/index.php/services/contact-us" class="btn btn-primary halflings chevron-right">Contact us today</a>
</div>  <div class="footNotes">
      <div class="container">
        <div class="row-fluid topSpace">
