...
<link rel="stylesheet" type="text/css" href="image/vivanta-technologies-mobile-apps-development.jpg" />
<style type="text/css">
...
<option value="Zimbabwe">Zimbabwe</option></optgroup></select>
              ...
              <div class="ui-tooltip"></div><label id="yourcitylabel" class="alert-error"></label>
                ...
                <input type="hidden" value="/mobile-apps-development" name="source" id="source"  />
